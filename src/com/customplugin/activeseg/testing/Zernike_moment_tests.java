...
import com.customplugin.activeseg.filters.Zernike_Filter_;
import ij.IJ;
import ij.ImagePlus;
import ij.gui.Roi;
...
public class Zernike_moment_tests {
    ...
    public static boolean check_return_encodings(){
        ...
        Zernike_Filter_ lm = new Zernike_Filter_();
        lm.applyFilter(ip,"encoding_image",null);
